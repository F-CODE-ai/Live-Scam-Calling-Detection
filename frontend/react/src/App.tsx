...
export default function App() {
  ...
  const startLiveSession = async () => {
    ...
    ws.onmessage = (event) => {
      ...
      console.log('RECEIVED FROM BACKEND:', update);
          ...
          <div>
            ...
            {sessionId && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.25rem', flexWrap: 'wrap' }}>
                ...
                <span style={{ fontSize: '0.7rem', color: wsStatus === 'Connected' ? '#10b981' : '#ef4444', fontFamily: 'monospace' }}>
                  WS: {wsStatus} | Messages received: {messagesReceived}
                </span>
              </div>
            )}
          </div>
